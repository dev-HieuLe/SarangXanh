...
const Banner = () => {
  ...
  return (
    ...
    >
      ...
      {/* Content wrapper */}
      <div
        className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 py-16 md:py-24 w-full max-w-6xl 2xl:max-w-[1600px] px-6 z-10 flex flex-col items-center"
      >
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 w-full">
          ...
          {/* Right Image */}
          <div className="flex-1 w-full flex justify-center md:justify-end" data-aos="zoom-in">
            <img
