...
const Navbar = () => {
  ...
  return (
    <nav className="absolute top-0 left-0 w-full z-50 backdrop-blur-xl shadow-none border-b bg-transparent border-gray-400">
      ...
      {isOpen && (
        <div className="md:hidden px-6 pb-4">
          <ul className="flex flex-col gap-4 text-sm font-semibold tracking-widest uppercase bg-white/30 backdrop-blur-md p-4 rounded-xl text-white">
